        ...
        if len(question_choices)<4:
            ...
            if request.method =='POST':
                ...
                if form.is_valid():
                    ...
                    if not existeCorrecta or not choice.correcta :
                        ...
                        return render(request, 'polls/detail.html', {'title':'Pregunta:'+ question.question_text,'question':question,'error_message':'ERROR: Una pregunta solo puede tener 1 opcion correcta'})
            ...
            return render(request, 'polls/detail.html', {'title':'Pregunta:'+ question.question_text,'question':question,'error_message':'ERROR: Una pregunta no puede tener mas de 4 opciones'})
